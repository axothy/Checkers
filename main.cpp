...
void Menu() {
	...
	int color = 0;
	int difficulty = 0;
	std::cout << "IF YOU WANT TO PLAY - PRESS 1" << std::endl;
	std::cout << "IF YOU WANT TO PLAY = PRESS 2" << std::endl;
	while ((play_or_watch == 1 || play_or_watch == 2) != true) {
		std::cin >> play_or_watch;
	}
	if (play_or_watch == 1) {
		std::cout << "IF YOU WANT TO PLAY WHITE - PRESS 1" << std::endl;
		std::cout << "IF YOU WANT TO PLAY BLACK - PRESS 2" << std::endl;
		while ((color == 1 || color == 2) != true) {
			std::cin >> color;
		}
		if (color == 1) {
		...
		std::cout << "IF YOU WANT PLAY VS PLAYER - PRESS 1" << std::endl;
		std::cout << "IF YOU WANT PLAY VS BOT - PRESS 2" << std::endl;
		play_or_watch = 0;
		while ((play_or_watch == 1 || play_or_watch == 2) != true) {
			std::cin >> play_or_watch;
		}
		...
		if (play_or_watch == 2) {
			std::cout << "IF YOU WANT PLAY VS EASY BOT - PRESS 1" << std::endl;
			std::cout << "IF YOU WANT PLAY VS NOT EASY BOT - PRESS 2" << std::endl;
			while ((difficulty == 1 || difficulty == 2) != true) {
				std::cin >> difficulty;
			}
			if (color == 1) {
				if (difficulty == 1) {
		...
		std::cout << "IF YOU WANT EASY BOT - WHITE VS NOTEASY BOT - BLACK - PRESS 1" << std::endl;
		std::cout << "IF YOU WANT NOTEASY BOT - WHITE VS EASY BOT - BLACK - PRESS 2" << std::endl;
		std::cout << "IF YOU WANT EASY BOT - WHITE VS EASY BOT - BLACK - PRESS 3" << std::endl;
		std::cout << "IF YOU WANT NOTEASY BOT - WHITE VS NOTEASY BOT - BLACK - PRESS 4" << std::endl;
		play_or_watch = 0;
